...
<html lang="en">
  ...
  <body class="font-sans text-gray-800 bg-gray-50">
        ...
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            <a href="/" class="flex items-center group">
              ...
              <span
                class="ml-2 text-xl font-bold text-primary-600 transition-all duration-300 group-hover:text-primary-700"
                >VoteSphere</span
              >
            </a>
          </div>
          <nav class="hidden md:flex space-x-8">
            <a
              href="/#features"
              class="text-gray-600 hover:text-primary-600 px-3 py-2 text-sm font-medium transition-colors duration-300 hover:scale-105 transform"
              >Features</a
            >
            <a
              href="/#how-it-works"
    ...
    >
      <div
        class="absolute inset-0 bg-gradient-to-r from-primary-50 to-white opacity-70 bg-gradient-animated"
      ></div>
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
        <div class="lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          >
            ...
            >
              <span class="block">Secure Online</span>
              <span class="block text-primary-600">Voting System</span>
            </h1>
            <p
            ...
            >
              A modern, secure, and transparent platform for conducting
              elections online. Accessible from anywhere, anytime.
            </p>
            <div
          ...
          >
            ...
            >
              <div class="relative block w-full rounded-lg overflow-hidden">
                <img
                  class="w-full"
                  src="${pageContext.request.contextPath}/uploads/vote.png"
                  alt="Voting illustration - I"
                />
              </div>
            </div>
          </div>
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center animate-on-scroll">
          <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            Features of Our Voting System
          </h2>
          <p class="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
            Designed with security, accessibility, and transparency in mind.
          </p>
        </div>
        ...
        <div class="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 animate-bounce-slow"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          >
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 animate-pulse-slow"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <p class="mt-2 text-gray-600">
              Cast your vote from anywhere in the world using any device with
              internet access.
            </p>
          </div>
          ...
          >
            ...
            <p class="mt-2 text-gray-600">
              Real-time results with verification mechanisms to ensure
          ...
          >
            ...
            <h3 class="text-xl font-bold text-gray-900">Flexible Scheduling</h3>
            <p class="mt-2 text-gray-600">
              Set up elections with custom voting periods to accommodate all
              voters' schedules.
            </p>
          </div>
          ...
          >
            ...
            <h3 class="text-xl font-bold text-gray-900">User Authentication</h3>
            <p class="mt-2 text-gray-600">
              Multi-factor authentication ensures only eligible voters can
              participate.
            </p>
          </div>
          ...
          >
            ...
            <p class="mt-2 text-gray-600">
              Comprehensive analytics and reporting tools for election
              administrators.
            </p>
          </div>
        </div>
    ...
    <section id="how-it-works" class="py-16 bg-white">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center animate-on-scroll">
          ...
          <p class="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
            Our voting system is designed to be simple, secure, and accessible.
          </p>
        </div>
          ...
          <div class="relative">
            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-6">
              ...
              >
                ...
                <div class="mt-2 ml-14">
                  <p class="text-base text-gray-500">
                    Create an account with your email and verify your identity
                    using our secure verification process.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div class="mt-2 ml-14">
                  <p class="text-base text-gray-500">
                    Once verified, you'll receive access to your digital ballot
                    for the elections you're eligible to vote in.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div class="mt-2 ml-14">
                  <p class="text-base text-gray-500">
                    Review the candidates and issues, make your selections, and
              ...
              <!-- Step 4 -->
              <div
                class="relative animate-on-scroll-left stagger-item"
                style="--i: 4"
              >
                <div class="flex items-center">
                  <div
                ...
                <div class="mt-2 ml-14">
                  <p class="text-base text-gray-500">
                    Receive a confirmation receipt and track your anonymized
                    ballot through the counting process.
                  </p>
                </div>
              </div>
            </div>
    ...
    <section id="faqs" class="py-16 bg-white">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center animate-on-scroll">
          ...
          <p class="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
            Find answers to common questions about our secure voting platform.
          </p>
        </div>
        ...
        <div class="mt-12 max-w-3xl mx-auto">
          ...
          <div class="mb-8 animate-on-scroll stagger-item" style="--i: 2">
            ...
            >
              ...
              >
                <span class="flex items-center">
                  ...
                  Can voters verify their votes were counted?
                </span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5 text-gray-500 transform transition-transform duration-300"
            ...
            <p class="mt-2 text-gray-600 ml-7 hidden faq-answer">
              Yes, each voter receives a unique verification code that allows
              them to confirm their vote was recorded correctly without
              revealing their specific choices, maintaining ballot secrecy while
          ...
          <div class="mb-8 animate-on-scroll stagger-item" style="--i: 3">
            ...
            >
              ...
              >
                <span class="flex items-center">
                  ...
                  What types of elections can VoteSphere handle?
                </span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5 text-gray-500 transform transition-transform duration-300"
            ...
            <p class="mt-2 text-gray-600 ml-7 hidden faq-answer">
              ...
              councils to national elections.
            </p>
          </div>
            ...
            >
              ...
              >
                <span class="flex items-center">
                  ...
                  How accessible is the voting platform?
                </span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5 text-gray-500 transform transition-transform duration-300"
          ...
          <div class="animate-on-scroll stagger-item" style="--i: 5">
            ...
            <p class="mt-2 text-gray-600 ml-7 hidden faq-answer">
              We offer 24/7 technical support during active elections,
              comprehensive documentation, video tutorials, and dedicated
              account managers for enterprise clients to ensure your voting
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto text-center animate-on-scroll">
          ...
          <p class="mt-4 text-xl text-primary-100">
            Join thousands of organizations that trust VoteSphere for their
            elections.
          </p>
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div class="col-span-1 animate-on-scroll">
            <div class="flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-10 w-10 text-primary-600 ==animate-spin-slow"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <span class="ml-3 text-2xl font-bold text-primary-600"
                >VoteSphere</span
              >
            </div>
            <p class="mt-4 text-gray-500 text-lg">
              Secure, transparent, and accessible online voting for
          ...
          <div class="animate-on-scroll-left" style="--i: 2">
            ...
            <div class="space-y-4">
              <div class="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5 text-primary-600 mt-1 mr-3"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <p class="text-gray-500">
                  VoteSphere Office, Kamal Pokhari, Kathmandu, Nepal
                </p>
              </div>
              <div class="flex items-start">
                <svg
              ...
              <div class="flex items-start">
                ...
                <p class="text-gray-500">+977 9844187887</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="mt-12 border-t border-gray-200 pt-8">
          <p class="text-base text-gray-500 text-center animate-pulse-slow">
            &copy; 2025 VoteSphere. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
