        ...
        <div class="lg:col-span-1">
          <div class="bg-white rounded-xl shadow-md overflow-hidden mb-6">
            <div class="p-6">
              <div class="flex items-center justify-between mb-4">
                <h2 class="text-2xl font-semibold text-gray-800 pt-2">Personal Information</h2>
              ...
              <div class="flex flex-col items-center mb-6">
                ...
                <h3 class="text-2xl font-semibold text-gray-800">${user.firstName} ${user.lastName}</h3>
           <p class="text-gray-500 pb-5 text-lg">
             Registered on <fmt:formatDate value="${user.createdAt}" pattern="dd MMMM yyyy" />
              ...
              <div class="space-y-4">
                ...
                <div class="flex justify-between items-center pb-2 border-b border-gray-100">
                  ...
                  <span class="font-medium text-${fn:length(user.notificationEmail) > 35 ? 'sm' : 'lg'} text-gray-800">${user.notificationEmail}</span>
                </div>
                <div class="flex justify-between items-center pb-2 border-b border-gray-100">
                  <span class="text-gray-500">Date of Birth</span>
                  <span class="font-medium text-gray-800"><fmt:formatDate value="${user.dob}" pattern="dd MMM yyyy" /></span>
                </div>
                <div class="flex justify-between items-center pb-2 border-b border-gray-100">
          ...
          <div class="bg-white rounded-xl shadow-md overflow-hidden mb-6">
            <div class="p-6">
              ...
              <div class="space-y-4">
                <div>
                  <h3 class="text-lg font-medium text-gray-500 mb-1">Temporary Address</h3>
                  <p class="text-gray-800 text-sm">${user.temporaryAddress}</p>
                </div>
                <div>
                  <h3 class="text-lg font-medium text-gray-500 mb-1">Permanent Address</h3>
                  <p class="text-gray-800 text-sm">${user.permanentAddress}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- Right Column: Document Verification -->
               <div class="lg:col-span-2">
                 ...
                 <div class="bg-white rounded-xl shadow-md overflow-hidden">
                   <div class="p-6">
                     <h2 class="text-2xl font-semibold text-gray-800 mb-6">Verification Documents</h2>
                     ...
                     <div class="mb-8">
                       ...
                       <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                         ...
                         <!-- Citizenship Back -->
                         <c:if test="${not empty user.citizenshipBack}">
                           <div class="document-card p-4">
                             <div class="flex items-center justify-between mb-3">
                     ...
                     <div class="mb-8">
                       ...
                       <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                         <!-- Image Holding Citizenship -->
                         <c:if test="${not empty user.imageHoldingCitizenship}">
                           <div class="document-card p-4">
                             <div class="flex items-center justify-between mb-3">
                               <h3 class="font-medium text-gray-700">Holding Citizenship</h3>
                               <span class="text-xs bg-green-100 text-green-800 px-2 py-0.5 rounded">Verified</span>
                             </div>
                             <div class="relative aspect-[4/3] bg-gray-100 rounded-md overflow-hidden mb-3">
