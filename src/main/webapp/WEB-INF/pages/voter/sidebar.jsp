...
<script>
  ...
  // Update voter name and email with dynamic data when available
  document.addEventListener("DOMContentLoaded", function () {
    // Here you would fetch the voter data and update the UI
    // For example:
    // const voterName = document.querySelector('.voter-name');
    // const voterEmail = document.querySelector('.voter-email');
    //
    // fetch('/api/voter-profile')
    //   .then(response => response.json())
    //   .then(data => {
    //     voterName.textContent = data.name;
    //     voterEmail.textContent = data.email;
    //   });
  });
</script>
